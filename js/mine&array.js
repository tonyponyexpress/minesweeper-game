...
//this function creates a 2d array based on the input rows and columns by the user
function array_func(rows, cols){
...
let practice = array_func(rows,cols);
mine_population(5, 10, 10, practice);
...
function do_everything(rows, cols, mines){
	//calls create to make 2d array
	//calls mine_population
	//calls unique_func
}
